...
///
/// @defgroup _accel_scaled 7-Series AHRS Example [C]
///
/// @ingroup examples_c
///
...
///
/// @section _accel_scaeld_license License
///
...
static const uint32_t RUN_TIME_SECONDS = 15;
////////////////////////////////////////////////////////////////////////////////
...
#error This example requires a logging level of at least MICROSTRAIN_LOGGING_LEVEL_INFO_ to work properly
    ...
    mip_sensor_comp_euler_angles_data   sensor_comp_euler       = {0};
    ...
    mip_interface_register_extractor(&device, &sensor_data_handlers[4], MIP_SENSOR_DATA_DESC_SET, MIP_DATA_DESC_SENSOR_COMP_EULER_ANGLES,   extract_mip_sensor_scaled_mag_data_from_field,      &sensor_comp_euler);
    ...
    mip_interface_register_extractor(
        ...
        MIP_FILTER_DATA_DESC_SET,                        // Data descriptor set
        MIP_DATA_DESC_FILTER_LINEAR_ACCELERATION,           // Data field descriptor set
        extract_mip_filter_linear_accel_data_from_field, // Callback
        &filter_linear_accel                                // Data field out
    );
    ...
    mip_interface_register_field_callback(
        ...
        MIP_FILTER_DATA_DESC_SET,          // Data descriptor set
        MIP_DATA_DESC_SHARED_EVENT_SOURCE, // Data field descriptor set
        ...
        if (current_timestamp - previous_print_timestamp >= 1000 / SAMPLE_RATE_HZ)
        {
            if (filter_status.filter_state >= MIP_FILTER_MODE_AHRS)
            {
                MICROSTRAIN_LOG_INFO(
                    ...
                    "Scaled Accel",
                    sensor_accel_scaled.scaled_accel[0],
                    sensor_accel_scaled.scaled_accel[1],
                    sensor_accel_scaled.scaled_accel[2]
                );
                MICROSTRAIN_LOG_INFO(
                    "%s = %10.3f%16s = [%9.6f, %9.6f, %9.6f]\n",
                    "TOW",
                    filter_gps_timestamp.tow,
                    "Linear Accel",
                    filter_linear_accel.accel[0],
                    filter_linear_accel.accel[1],
                    filter_linear_accel.accel[2]
                );
            }
...
static void configure_sensor_message_format(mip_interface* _device)
{
    ...
    const mip_descriptor_rate sensor_descriptors[5] = {
        ...
        {MIP_DATA_DESC_SENSOR_COMP_EULER_ANGLES,sensor_decimation}
    };
...
static void configure_filter_message_format(mip_interface* _device)
{
    ...
    // Descriptor rate is a pair of data descriptor set and decimation
    const mip_descriptor_rate filter_descriptors[4] = {
        ...
        {MIP_DATA_DESC_FILTER_ATT_UNCERTAINTY_EULER,filter_decimation}
    };
