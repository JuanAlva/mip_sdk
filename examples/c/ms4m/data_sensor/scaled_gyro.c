...
///
/// @defgroup _ypr 7-Series AHRS Example [C]
///
/// @ingroup examples_c
///
...
#error This example requires a logging level of at least MICROSTRAIN_LOGGING_LEVEL_INFO_ to work properly
    ...
    mip_filter_euler_angles_uncertainty_data    filter_euler_angles_uncertainty = {0};
    ...
    mip_interface_register_extractor(
        ...
        MIP_FILTER_DATA_DESC_SET,                        // Data descriptor set
        MIP_DATA_DESC_FILTER_ATT_UNCERTAINTY_EULER,           // Data field descriptor set
        extract_mip_filter_euler_angles_uncertainty_data_from_field, // Callback
        &filter_euler_angles_uncertainty                             // Data field out
    );
